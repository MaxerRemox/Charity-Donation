document.addEventListener("DOMContentLoaded", function() {
  ...
  function street(){
    ...
    x.innerText = x.value.toUpperCase();
  }
  ...
  class FormSteps {
    ...
    updateForm() {
      ...
      document.getElementById("summaryPickUpComment").innerText = document.getElementById("pickUpComment").value;
      ...
      const categories = document.querySelectorAll("[name ='categories']:checked ~ .description");
      let categoryView = "";
      for (let i = 0; i < categories.length; i++) {
        categoryView = categoryView + categories[i].innerText + ", ";
      }
      document.getElementById("catAndQuant").innerText = categoryView;
      let quant = document.getElementById("quantity").value;
      let instit = document.querySelector("[name = 'institution']:checked ~ .description .title").innerText;
      document.getElementById("summaryInstitution").innerText = quant + " worki dla " + instit;
    }
